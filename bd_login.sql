...
--
-- OBS: as senhas abaixo já estão em hash (bcrypt). Senhas originais:
-- adm@gmail.com -> adm0102
-- usuario@gmail.com -> usuario0102

INSERT INTO usuarios (id, nome, email, senha, telefone, endereco, nivel, data_criacao) VALUES
(1, 'Administrador', 'adm@gmail.com', '$2b$12$dVrOpLljqC2rDdzSEVY7ReAY5T8ZbuqUtyNEKrNIIaCgbuHooaHfG', '(11) 9999-9999', 'Rua da Administração, 123', 'admin', '2025-10-08 17:49:00'),
(2, 'Usuário Teste', 'usuario@gmail.com', '$2b$12$yJiEzj7oAasDfDjspkWT0u8GkYwy/YdxMVXstkp.RIIf2AkSeL8v2', '(11) 8888-8888', 'Rua do Usuário, 456', 'user', '2025-10-08 17:49:00');

-- --------------------------------------------------------

-- (restante do dump mantido exatamente como você forneceu)
...
-- Índices e constraints (mantidos iguais ao original)
ALTER TABLE carros
  ADD PRIMARY KEY (id),
